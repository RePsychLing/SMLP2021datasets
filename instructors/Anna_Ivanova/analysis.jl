...
# ╔═╡ 51544f7c-1194-11ec-3b02-ddd1b5696f77
begin
	using CairoMakie
...
# ╔═╡ d3f37b92-3202-414d-9da0-20c9c3694a68
md"""

# Analysis of fMRI data provided by Anna Ivanova

*by Phillip Alday*

"""

# ╔═╡ f67b5d37-3975-48ee-991a-2045ede466eb
md"""
...
# ╔═╡ 1a4bcadd-b099-4d9e-b85c-5cf9c3d0bbf9
md"""

This happens to be a unique fMRI experiment that we run for every participant that comes to the lab, so we have several hundred subjects (599 here). The updated analysis file is marked with “_20210907”. The full dataset is under “fROI_data_large.csv”. The predictor information is the same for every participant so I’m also providing separate files, “fROI_data_large_nopredictors” and “langlocSN_predictors”, that can be merged by Time and Run.

"""

# ╔═╡ 6e80db05-3627-49c1-a1e3-6f39926b0038
begin
	dat = Arrow.Table("../../Anna_Ivanova/fROI_data_large.arrow")
end
...
# ╔═╡ 494daa12-5170-4be2-a96c-c009208ec00c
begin
	mrun = fit(MixedModel, 
			   @formula(value ~ 1 + Sentences * Nonwords * Run + 
									# R1 + R2 + R3 + R4 + R5 + R6 + 
							   (1 + Sentences + Nonwords + Run | fROI) +
							   (1 + Sentences + Nonwords + Run |Subject)), 
				dat; contrasts=contr)
	mrun |> DisplayAs.Text
end

# ╔═╡ 059208ad-4744-48e9-8e4a-9a13354383b4
mrun

# ╔═╡ 63b7fc69-33ed-4b63-9e07-d51675d9352e
